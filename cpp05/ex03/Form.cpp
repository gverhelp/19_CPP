...
std::ostream &operator<<(std::ostream &o, const Form &rhs)
{
    ...
    o << "This form need a bureaucrat graded <" << rhs.getGradeToSign() << "> or more to be signed and can be executed by a bureaucrat graded <" << rhs.getGradeToExec() << "> or more." << std::endl;
    return (o);
}